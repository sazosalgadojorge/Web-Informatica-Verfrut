  ...
  return (
    <div className="verfrut-cloud-post">
      <p className="blog-content">
        ...
        la industria agroexportadora no se queda atrás. Verfrut, uno de los principales exportadores de
        fruta fresca de Sudamérica, ha dado un paso decisivo hacia la transformación digital con la
        implementación de <strong>Verfrut Cloud</strong>, una solución tecnológica desarrollada
      ...
      <blockquote className="blockquote my-4 ps-3 border-start border-3 border-primary">
        ...
        <cite className="text-muted">— Verfrut Chile y Perú</cite>
      </blockquote>

      <p className="blog-content">
        Verfrut Cloud es más que un sistema de gestión: es una plataforma integral que permite controlar
      ...
      <p className="blog-content">
        “Con Verfrut Cloud logramos una trazabilidad completa del producto, lo que nos permite cumplir
        con los estándares internacionales y responder con agilidad a los requerimientos de los mercados
        más exigentes”, explica uno de los líderes del equipo tecnológico de Verfrut.
      </p>
      ...
      <p className="blog-content">
        Verfrut Cloud también destaca por su accesibilidad desde cualquier dispositivo conectado,
      ...
      <p className="blog-content">
        Una de las mayores fortalezas de Verfrut Cloud es su capacidad para integrar datos de distintas
      ...
      <p className="blog-content">
        El desarrollo de Verfrut Cloud marca un hito en la historia tecnológica de la empresa.
        Actualmente, el sistema continúa evolucionando con módulos especializados en recursos humanos,
        finanzas y gestión ambiental, consolidando a Verfrut como una agroexportadora con visión de
        futuro y fuerte enfoque en la innovación digital.
      </p>

      <p className="blog-content">
        Con Verfrut Cloud, la empresa no solo está mejorando su competitividad, sino también elevando
