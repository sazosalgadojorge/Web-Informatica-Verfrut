  ...
  return (
    <>
      ...
      <div className="blog-content pt-3" style={{ fontSize: 'larger' }}>
        <p>
          🔹 <strong>Solicitante:</strong> Registra la incidencia en GLPi con todos los detalles
          necesarios: qué, por qué, cuándo y cómo. Debe colaborar estrechamente con el técnico para
          facilitar la resolución.
        </p>
        <p>
          🔹 <strong>Técnico Asignado:</strong> Revisa la incidencia, establece comunicación con el
          solicitante, y documenta el proceso siguiendo metodologías ágiles en GLPi.
        </p>
        <p>
          🔹 <strong>Responsable de Asignar Incidencias:</strong> Asigna los casos y establece fechas
          tentativas para la resolución.
        </p>
        <p>
          🔹 <strong>Jefe de Proyecto y Subgerente de TI:</strong> Revisan, aprueban cambios en los
          plazos y garantizan la calidad de las soluciones entregadas.
        </p>
      </div>
      ...
      <div className="blog-content pt-3" style={{ fontSize: 'larger' }}>
        ...
        <p>🕑 <strong>Errores:</strong> máximo 24 horas</p>
        <p>🕑 <strong>Modificaciones:</strong> hasta 1 semana</p>
        <p>🕑 <strong>Nuevos desarrollos:</strong> plazos definidos en conjunto con las áreas involucradas</p>
      </div>
      ...
      <p className="blog-content">
        La documentación y el seguimiento se realizan a través de metodologías ágiles, reforzadas con
        canales de comunicación como correo electrónico, reuniones virtuales y la plataforma GLPi.
        Esto garantiza la transparencia y el registro completo de cada paso.
      </p>

      <h3 className="blog-subtitle pt-2">👉 Mejora Continua</h3>
      <p className="blog-content">
        Este protocolo es dinámico y está sujeto a revisiones constantes para detectar áreas de
        mejora. Se promueve la capacitación permanente del personal para asegurar una gestión de
        incidencias efectiva y alineada con las mejores prácticas.
      </p>

      <h3 className="blog-subtitle pt-2">📝 Cómo registrar una incidencia</h3>
      <p className="blog-content">
        Para garantizar una atención rápida y eficiente, sigue estos pasos al registrar tu incidencia:
      </p>
      ...
      <ol>
        ...
        <li className="blog-content">
          ...
          <div className="blog-content">
            <strong>Qué necesitas:</strong> una descripción clara y precisa de la solicitud o problema.<br />
            ...
            <strong>Cómo esperas que sea resuelto:</strong> cualquier detalle técnico o de formato relevante.
          </div>
        </li>
        <li className="blog-content">
          <strong>Adjunta la información necesaria</strong>
          <br />
          Si es posible, añade capturas de pantalla, documentos o cualquier otro archivo que ayude a
          ilustrar mejor el problema o solicitud.
        </li>
        <li className="blog-content">
          <strong>Mantente disponible</strong>
          <br />
          Una vez registrada, el técnico asignado se pondrá en contacto contigo para aclarar dudas o
          solicitar más información si es necesario. Tu colaboración es clave para resolver la
      ...
      <p className="blog-content">
        Con este protocolo y el uso de la plataforma GLPi, buscamos optimizar la gestión de incidencias
        y asegurar que todos los problemas o solicitudes sean atendidos de forma oportuna. La
        participación activa de cada usuario y la colaboración con el equipo de soporte son
        fundamentales para lograr soluciones rápidas y efectivas.
      </p>
    </>
  )
}
